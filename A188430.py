# python program to produce series of the sequence in https://oeis.org/A188430
...
def sequence_term(n):  # returns the maximum of the set {max A: (sum A)=[n] }
    max_nfull = []
    for i in nfull(n):
